...
const frontendSkills = [
  ...
  { name: 'JavaScript', src: 'icon/js.png', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
  ...
  { name: 'Bootstrap', src: 'icon/bootstrap.png', url: 'https://getbootstrap.com' },
  ...
  { name: 'TypeScript', src: 'icon/ts.jpeg', url: 'https://www.typescriptlang.org/' },
];
...
const databaseSkills = [
  ...
  { name: 'PostgreSql', src: 'icon/postgreSql.png', url: 'https://www.postgresql.org/' },
  ...
  const renderSkills = (skills) => {
    return skills.map((skill, index) => (
      <div className="skill-item" key={index}>
        ...
        <img key={index} src={skill.src} alt={skill.name} style={{mixBlendMode: "multiply"}}/>
      </div>
